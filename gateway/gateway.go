...
import (
	...
	"github.com/go-dyn/api-grpc-service/insecure"
	usersv1 "github.com/go-dyn/api-grpc-service/proto/users/v1"
	thirtParty "github.com/go-dyn/api-grpc-service/swagger"
...
func getOpenAPIHandler() http.Handler {
	...
	subFS, err := fs.Sub(thirtParty.OpenAPI, "OpenAPI")
	if err != nil {
